...
/*package*/ class SemanticDomain_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.semanticDomainDef$4nE5;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.semanticDomainDef$4nE5);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.semanticDomainDef$4nE5);
    }
